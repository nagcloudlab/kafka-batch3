...
public class StreamsClient {
    ...
    public static void main(String[] args) {
        ...
        streamsProperties.put("application.id", "numbers-streams-statefull");
        ...
        // stateful processing
        // how many even numbers received so far
        // how many odd numbers received so far
        numbers
                .selectKey((key, value) -> Integer.parseInt(value) % 2 == 0 ? "even" : "odd")
                .groupByKey()
                .count()
                .toStream()
                .to("odd-even-count",Produced.with(org.apache.kafka.common.serialization.Serdes.String(), org.apache.kafka.common.serialization.Serdes.Long()));
...
// - this api implementation available only in java
// or
