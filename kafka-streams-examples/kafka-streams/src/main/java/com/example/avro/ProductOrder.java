...
public class ProductOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4760635004780213923L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProductOrder\",\"namespace\":\"com.example.avro\",\"fields\":[{\"name\":\"order_id\",\"type\":\"string\"},{\"name\":\"product\",\"type\":\"string\"},{\"name\":\"user_id\",\"type\":\"string\"},{\"name\":\"time\",\"type\":\"long\"}]}");
   ...
   */
  public static com.example.avro.ProductOrder.Builder newBuilder() {
    return new com.example.avro.ProductOrder.Builder();
  }
   ...
   * @return A new ProductOrder RecordBuilder
   */
  public static com.example.avro.ProductOrder.Builder newBuilder(com.example.avro.ProductOrder.Builder other) {
    if (other == null) {
      return new com.example.avro.ProductOrder.Builder();
    } else {
      return new com.example.avro.ProductOrder.Builder(other);
    }
  }
   ...
   * @return A new ProductOrder RecordBuilder
   */
  public static com.example.avro.ProductOrder.Builder newBuilder(com.example.avro.ProductOrder other) {
    if (other == null) {
      return new com.example.avro.ProductOrder.Builder();
    } else {
      return new com.example.avro.ProductOrder.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductOrder>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.avro.ProductOrder.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.avro.ProductOrder other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.order_id)) {
        this.order_id = data().deepCopy(fields()[0].schema(), other.order_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.ProductOrder.Builder setOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.ProductOrder.Builder clearOrderId() {
      order_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.ProductOrder.Builder setProduct(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.ProductOrder.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.ProductOrder.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.ProductOrder.Builder clearUserId() {
      user_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.ProductOrder.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.ProductOrder.Builder clearTime() {
